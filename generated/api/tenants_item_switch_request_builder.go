...
// NewTenantsItemSwitchRequestBuilder instantiates a new TenantsItemSwitchRequestBuilder and sets the default values.
func NewTenantsItemSwitchRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TenantsItemSwitchRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewTenantsItemSwitchRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *TenantsItemSwitchRequestBuilder) Post(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])(i8cb6f6b3ef9d526a285dccfc6572e3abf87504b915a3847eb9d5aebdf2472c1d.SwitchTenantResponseable, error) {
    ...
    return res.(i8cb6f6b3ef9d526a285dccfc6572e3abf87504b915a3847eb9d5aebdf2472c1d.SwitchTenantResponseable), nil
}
// ToPostRequestInformation pOST_api_tenants_id_switch
// returns a *RequestInformation when successful
func (m *TenantsItemSwitchRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *TenantsItemSwitchRequestBuilder) WithUrl(rawUrl string)(*TenantsItemSwitchRequestBuilder) {
    return NewTenantsItemSwitchRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
