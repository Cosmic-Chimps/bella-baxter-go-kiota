...
// NewAccessLogEntry instantiates a new AccessLogEntry and sets the default values.
func NewAccessLogEntry()(*AccessLogEntry) {
    m := &AccessLogEntry{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateAccessLogEntryFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateAccessLogEntryFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewAccessLogEntry(), nil
}
// GetAction gets the action property value. The action property
// returns a *string when successful
func (m *AccessLogEntry) GetAction()(*string) {
    return m.action
}
// GetActorType gets the actorType property value. The actorType property
// returns a *string when successful
func (m *AccessLogEntry) GetActorType()(*string) {
    return m.actorType
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *AccessLogEntry) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetApiKeyId gets the apiKeyId property value. The apiKeyId property
// returns a *UUID when successful
func (m *AccessLogEntry) GetApiKeyId()(*i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID) {
    return m.apiKeyId
}
// GetApiKeyName gets the apiKeyName property value. The apiKeyName property
// returns a *string when successful
func (m *AccessLogEntry) GetApiKeyName()(*string) {
    return m.apiKeyName
}
...
// returns a *UUID when successful
func (m *AccessLogEntry) GetEnvironmentId()(*i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID) {
    return m.environmentId
}
// GetEnvironmentSlug gets the environmentSlug property value. The environmentSlug property
// returns a *string when successful
func (m *AccessLogEntry) GetEnvironmentSlug()(*string) {
    return m.environmentSlug
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *AccessLogEntry) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *UUID when successful
func (m *AccessLogEntry) GetId()(*i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID) {
    return m.id
}
...
// returns a *string when successful
func (m *AccessLogEntry) GetProjectSlug()(*string) {
    return m.projectSlug
}
// GetProviderId gets the providerId property value. The providerId property
// returns a *UUID when successful
func (m *AccessLogEntry) GetProviderId()(*i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID) {
    return m.providerId
}
// GetSecretKey gets the secretKey property value. The secretKey property
// returns a *string when successful
func (m *AccessLogEntry) GetSecretKey()(*string) {
    return m.secretKey
}
...
// returns a *UUID when successful
func (m *AccessLogEntry) GetUserId()(*i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID) {
    return m.userId
}
// GetUserName gets the userName property value. The userName property
// returns a *string when successful
func (m *AccessLogEntry) GetUserName()(*string) {
    return m.userName
}
// Serialize serializes information the current object
func (m *AccessLogEntry) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *AccessLogEntry) SetAction(value *string)() {
    m.action = value
}
// SetActorType sets the actorType property value. The actorType property
func (m *AccessLogEntry) SetActorType(value *string)() {
    m.actorType = value
}
// SetAdditionalData sets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *AccessLogEntry) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetApiKeyId sets the apiKeyId property value. The apiKeyId property
func (m *AccessLogEntry) SetApiKeyId(value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)() {
    m.apiKeyId = value
}
// SetApiKeyName sets the apiKeyName property value. The apiKeyName property
func (m *AccessLogEntry) SetApiKeyName(value *string)() {
    m.apiKeyName = value
}
...
func (m *AccessLogEntry) SetEnvironmentSlug(value *string)() {
    m.environmentSlug = value
}
// SetId sets the id property value. The id property
func (m *AccessLogEntry) SetId(value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)() {
    m.id = value
}
...
func (m *AccessLogEntry) SetProjectSlug(value *string)() {
    m.projectSlug = value
}
// SetProviderId sets the providerId property value. The providerId property
func (m *AccessLogEntry) SetProviderId(value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)() {
    m.providerId = value
}
// SetSecretKey sets the secretKey property value. The secretKey property
func (m *AccessLogEntry) SetSecretKey(value *string)() {
    m.secretKey = value
}
...
func (m *AccessLogEntry) SetUserId(value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)() {
    m.userId = value
}
// SetUserName sets the userName property value. The userName property
func (m *AccessLogEntry) SetUserName(value *string)() {
    m.userName = value
}
type AccessLogEntryable interface {
