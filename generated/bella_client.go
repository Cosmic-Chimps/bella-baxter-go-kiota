...
type BellaClient struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// Api the api property
// returns a *ApiRequestBuilder when successful
func (m *BellaClient) Api()(*i4d5feba19df46e76da81fcde661b9fc3885093da0043802d86d4fc92a3088e74.ApiRequestBuilder) {
    return i4d5feba19df46e76da81fcde661b9fc3885093da0043802d86d4fc92a3088e74.NewApiRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// NewBellaClient instantiates a new BellaClient and sets the default values.
func NewBellaClient(requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*BellaClient) {
    m := &BellaClient{
    ...
    if m.BaseRequestBuilder.RequestAdapter.GetBaseUrl() == "" {
        m.BaseRequestBuilder.RequestAdapter.SetBaseUrl("http://localhost:5522")
    }
